...
Review.create(star_rating: 3, restaurant_id: bistro.id, customer_id: scary_spice.id)
Review.create(star_rating: 4, restaurant_id: palace.id, customer_id: posh_spice.id)
